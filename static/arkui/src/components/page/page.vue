<template>
    ...
    <ul :class="wrapClasses" :style="styles" v-else>
        ...
        <li :title="t('i.page.prev5')" v-if="currentPage > 5" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev"><a><Icon type="ios-arrow-back"></Icon></a></li>
        ...
        <li :title="t('i.page.next5')" v-if="allPages - currentPage >= 5" :class="[prefixCls + '-item-jump-next']" @click="fastNext"><a><Icon type="ios-arrow-forward"></Icon></a></li>
