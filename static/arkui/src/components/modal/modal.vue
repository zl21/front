...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            mainStyles() {
                ...
                const styleWidth = this.dragData.x !== null
                    ...
                    : {
                        width: width <= 100 ? `${width}%` : this.innerWid > this.width ? `${width}px` : `${this.innerWid - 13}px`
                    };
            ...
            contentStyles() {
                ...
                if (this.innerWid < this.width) {
                    Object.assign(style, {width: 'auto'});
                }
                return style;
            },
            localeOkText() {
        ...
        mounted() {
            ...
            this.innerWid = window.innerWidth;
