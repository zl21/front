...
<template>
    <div :class="prefixCls" @click.stop>
        ...
        <div class="table multi-table">
            <slot>
                <table>
                    ...
                    <tbody>
                    <tr v-for="(item, index) in tabrow" :key="index" :data-index="index" v-if="single" @click.stop="radioChange(radioSelectedValue(item),radioLable[index],item)">
        ...
        <Spin fix v-show="spinShow">
            ...
            <div>{{t('i.fkrpSelect.loading')}}</div>
        </Spin>
    </div>
</template>
