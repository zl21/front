<template>
    <div :class="classes" ref="tabsWrap">
        <div :class="[prefixCls + '-bar']">
            ...
            >
                <div ref="navWrap" :class="[prefixCls + '-nav-wrap', scrollable ? prefixCls + '-nav-scrollable' : '']">
                    ...
                    <div ref="navScroll" :class="[prefixCls + '-nav-scroll']" @DOMMouseScroll="handleScroll"
                        ...
                        <div ref="nav" :class="[prefixCls + '-nav']" :style="navStyle">
                            ...
                            >
                                ...
                                <Icon :class="[prefixCls + '-close']" v-if="showClose(item)" :type="arrowType"
                                      :custom="customArrowType" :size="arrowSize"
        ...
        <div v-if="contextMenuVisible" class="ivu-tabs-context-menu" :style="contextMenuStyles">
            <Dropdown trigger="custom" :visible="contextMenuVisible" transfer
...
<script>
    ...
    const prefixCls = `${burgeonConfig.prefixCls}tabs`;
    ...
    export default {
        ...
        mixins: [Emitter],
        components: {
            Icon, Render, Dropdown, DropdownMenu
        },
        provide() {
        ...
        methods: {
            ...
            handleDrop(index, event) {
                ...
                if (nav) {
                    ...
                    const a = window.parseInt16(navNames.findIndex(item => item === dragName));
                    const b = window.parseInt16(navNames.findIndex(item => item === nav.name));
