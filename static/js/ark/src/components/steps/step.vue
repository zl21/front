<template>
    <div :class="wrapClasses" :style="styles">
        ...
        <div :class="[prefixCls + '-head']" v-if="!$slots.default">
            <div :class="[prefixCls + '-head-inner']">
                <span v-if="!icon && currentStatus != 'finish' && currentStatus != 'error'">{{ stepNumber }}</span>
                <span v-else :class="iconClasses"></span>
            </div>
        </div>
        <div :class="[prefixCls + '-main']" v-if="!$slots.default">
        ...
        <div v-if="$slots.default"  :class="[prefixCls + '-stepSlot']">
            <slot ></slot>
        </div>
    </div>
</template>
<script>
    ...
    const prefixCls = `${burgeonConfig.prefixCls}steps`;
