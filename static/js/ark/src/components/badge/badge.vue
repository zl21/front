<template>
    ...
    <span v-else-if="status"  :class="badgeStatusClass" ref="badge">
...
<script>
    ...
    const prefixCls = `${burgeonConfig.prefixCls}badge`;
    ...
    export default {
        ...
        computed: {
            ...
            badgeStatusClass () {
                return [
                    this.classes,
                    `${burgeonConfig.prefixCls}badge-status`
                ];
            },
            statusClasses () {
                return [
            ...
            statusTextClasses () {
                return [
                    `${burgeonConfig.prefixCls}badge-status-text`
                ];
            },
            styles () {
                const style = {};
