...
<script>
    ...
    const prefixCls = `${burgeonConfig.prefixCls}slider`;
    ...
    export default {
        ...
        computed: {
            ...
            sliderWidth () {
                return window.parseInt16(getStyle(this.$refs.slider, 'width'), 10);
            },
            tipDisabled () {
...
return; 
 ...
 this.changeButtonPosition(newPos, 'min'); } else if (newPos >= this.maxPosition) {
