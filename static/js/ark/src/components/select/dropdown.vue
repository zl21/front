...
<script>
    ...
    export default {
        ...
        computed: {
            classes() {
                return [
                    `${burgeonConfig.prefixCls}select-dropdown`,
                    this.className
                ];
            },
            styles() {
                ...
                if (this.transfer) {
                    style['z-index'] = Vue.prototype.$IVIEW.defaultZindex + 160 + this.tIndex;
                }
                return style;
            }
        },
        methods: {
            update() {
                ...
                if (this.popper) {
                    ...
                    this.$nextTick(() => {
                        ...
                        this.popper = new Popper(this.$parent.$refs.reference, this.$el, {
                            ...
                            onCreate: () => {
                                this.popper.popper.scrollTop = 0;
                ...
                if (this.$parent.$options.name === 'iSelect') {
                    this.width = window.parseInt16(getStyle(this.$parent.$el, 'width'));
                }
