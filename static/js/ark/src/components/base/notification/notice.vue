        ...
        <div  :class="classes" :style="styles">
            <template v-if="type === 'notice'">
                <template v-if="contentComponent">
                    <render-cell
                        :render="function(h) {
                            return contentComponent(h,close)
                        }"
                    ></render-cell>
                </template>
                <template v-else>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleLeave (el) {
                if (this.type === 'message') {
                    ...
                    if (document.getElementsByClassName(`${burgeonConfig.prefixCls}message-notice`).length !== 1) {
                        el.style.height = 0;
        ...
        mounted () {
            ...
            if (this.prefixCls === `${burgeonConfig.prefixCls}notice` && this.$refs.content) {
