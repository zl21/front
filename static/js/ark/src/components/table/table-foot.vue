    ...
    <template v-for="(row, index) in data">
        <table-tr :row="row"
            ...
            <template v-for="column in columns"
                ...
                <td :class="tdPrefixCls(column)"
                    :colspan="row.colspan"
                    :rowspan="column.rowspan">
                    <template v-if="column.fixed!== '' ">
                        <div :class="alignClsfooter(column, row)"
        ...
        computed: {
            ...
            tdPrefixCls() {
                return function (column) {
                    // 合计
                    if (this.totalAlign) {
                        return `${this.prefixCls}-column-${this.totalAlign}`;
                    }
                    if (column.align === 'center') {
                        return [`${this.prefixCls}-column-center`];
                    }
                    if (column.align === 'right') {
                        return `${this.prefixCls}-column-right`;
                    }
                    if (column.align === 'left') {
                        return `${this.prefixCls}-column-left`;
                    }
