  ...
  <div :class="prefixClass">
    ...
    <div class="fkrp-poptip-text">
      <i v-if="InputVale"
         :class="[
                       prefixCls+'icon',
                       prefixCls+'iconios-close-circle iconfont iconios-close-circle',
                       prefixCls + '-icon',
...
export default {
  ...
  data () {
    return {
      ...
      complexs: false,
      showDaigo: {
        title: this.t('i.modal.title'),
        width: 100,
        closable: true,
        scrollable: true,
        okText: this.t('i.modal.okText'),
        cancelText: this.t('i.modal.cancelText')
      },
  ...
  methods: {
    ...
    handleChange (event) {
      // this.$emit('input', this.InputVale || '', this);
