                ...
                if (this.disabled) {
                    ...
                    if (typeof this.isShowPopTip === 'function') {
                        ...
                        if (!promiseResult) {
                            ...
                            setTimeout(() => {
                                // console.log('this.popperVisible', this.popperVisible)
                                this.popperVisible = !this.popperVisible;
                                this.computedPoperPosition();
                            }, 300);
                        }
            ...
            computedPoperPosition() {
                if (this.popperVisible) {
                    this.$nextTick(() => {
                        ...
                        // console.log('iconToBottomDistance', iconToBottomDistance)
                        // console.log('iconBottom', iconBottom)
                        if (iconToBottomDistance < iconBottom) {
                            ...
                            this.$nextTick(() => {
                                ...
                                // console.log('poppetDoc.clientHeight', poppetDoc.clientHeight);
