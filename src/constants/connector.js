...
const port = {
  ...
  DL_B_TRAN_OUT_POS: {
    ...
    matchData: {
      data: [
        {
          label: i18n.t('messages.shippingWarehouse'),
          value: 'qty_stock_able',
          port: 1, // 表示第一个接口
        },
        {
          label: i18n.t('messages.receivingWarehouse'),
          value: 'qty_stock_able',
          port: 2, // 表示第二个接口
        },
      ],
  ...
  DL_B_INV_ADJ: {
    ...
    matchData: {
      data: [
        {
          label: i18n.t('messages.inventory'),
          value: 'qty_stock', // 字段名
          port: 1, // 表示第一个接口
        },
        {
          label: i18n.t('messages.availableInventory'),
  ...
  DL_B_PUR_RET: {
    ...
    matchData: {
      data: [
        {
          label: i18n.t('messages.availableReturnWarehouse'),
          value: 'qty_stock_able',
          port: 1, // 表示第一个接口
        },
        {
          label: i18n.t('messages.returnWarehouseInStock'),
          value: 'qty_stock',
          port: 1, // 表示第一个接口
        },
      ],
  ...
  OC_B_ORDER: {
    ...
    virtualName: 'OC_B_ORDER_ITEM', // 虚表表名
    isDeleteBtn: true, // 是否有删除明细按钮
    matchData: {},
    hasMatch: false, // 是否有匹配矩阵
    hasStock: true, // 获取库存接口
  ...
  OC_B_SALE: {
    ...
    isDeleteBtn: true, // 是否有删除明细按钮
    isUpdateDiscountBtn: true, // 是否有修改折扣按钮
    matchData: {},
    hasMatch: false, // 是否有匹配矩阵
    noZeroShwoFlag: true,
    hasStock: true, // 获取库存接口
  ...
  OC_B_REFUND_SALE: {
    ...
    isDeleteBtn: true, // 是否有删除明细按钮
    isUpdateDiscountBtn: true, // 是否有修改折扣明细按钮
    matchData: {},
    hasMatch: false, // 是否有匹配矩阵
    hasStock: true, // 获取库存接口
    isStock: true, // 配置默认显示在库的还是可用的
