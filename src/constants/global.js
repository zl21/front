...
export const enableOpenNewTab = () => (window.ProjectConfig && window.ProjectConfig.enableOpenNewTab ? window.ProjectConfig.enableOpenNewTab : project.enableOpenNewTab);
