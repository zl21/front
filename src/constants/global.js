...
export const enableAsyncTaskTip = () => (window.ProjectConfig && window.ProjectConfig.enableAsyncTaskTip ? window.ProjectConfig.enableAsyncTaskTip : false); // 点击导出，如果是异步则立即弹出提示弹框。用于兼容旧版异步消息提示
export const enableTaskNotice = () => (window.ProjectConfig && window.ProjectConfig.enableTaskNotice ? window.ProjectConfig.enableTaskNotice : false); // 异步任务，右下角消息通知
