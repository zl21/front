      ...
      b() {
        const data1 = {
          ...
          data: {
            addcolums: [
              ...
              {
                hrdisplay: 'expand(1)',
                parentname: '(T_V_WMSALLOCATEBILL.ID+10)(1)',
                size: 6,
                parentdesc: '基础信息(1)',
                childs: [
                  {
                    col: 1,
                    reftable: 'T_IESSTORE(1)',
                    objdisplay: 'object(1)',
                    display: 'text(1)',
                    length: 20,
                    reftableid: 10644,
                    ...
                    statsize: -1,
                    datelimit: 'all(1)',
                    colname: 'OUTSTOREID(1)',
                    readonly: false,
                    isuppercase: false,
                    isnotnull: false,
                    fkdesc: '逻辑仓档案(1)',
                    name: '出库仓库(1)',
                    valuedata: '伯俊上海天猫电商仓(1)',
                    fkdisplay: 'drp(1)',
                    row: 1,
                    serviceId: null,
                    inputname: 'OUTSTOREID:STORENAME(1)',
                    colid: 198103,
                    isfk: true
                  },
                  {
                    col: 1,
                    reftable: 'T_V_IESSTORE_WITHNOPERMISSION(1)',
                    objdisplay: 'object(1)',
                    display: 'text(1)',
                    length: 20,
                    reftableid: 10866,
                    ...
                    row: 1,
                    serviceId: null,
                    inputname: 'INSTOREID:STORENAME(1)',
                    colid: 198106,
                    isfk: true
                  },
                  {
              ...
              {
                hrdisplay: 'expand(1)',
                parentname: '(T_V_WMSALLOCATEBILL.ID+100)(1)',
                size: 7,
                parentdesc: '日志(1)',
                childs: [
                  {
                  ...
                  },
                  {
                    ...
                    statsize: -1,
                    datelimit: 'all(1)',
                    colname: 'MODIFIEDDATE(1)',
                    readonly: true,
                    isuppercase: false,
                    isnotnull: false,
                    name: '修改时间(1)',
                    valuedata: '2021-02-26 21:44:39(1)',
                    row: 1,
                    colid: 198084
                  },
                  {
                  ...
                  },
                  {
                    ...
                    isnotnull: true,
                    name: '审核时间(1)',
                    valuedata: '2021-02-26 21:44:43(1)',
                    row: 1,
                    colid: 198098
                  }
                ]
        ...
        const data2 = {
          addcolums: [
            ...
            {
              hrdisplay: 'expand(2)',
              parentname: '(T_V_WMSALLOCATEBILL.ID+10)(2)',
              size: 3,
              parentdesc: '基础信息(2)',
              childs: [
                {
                  col: 1,
                  reftable: 'T_IESSTORE(2)',
                  objdisplay: 'object(2)',
                  display: 'text(2)',
                  length: 20,
                  reftableid: 10644,
                  ...
                  row: 1,
                  serviceId: null,
                  inputname: 'OUTSTOREID:STORENAME(2)',
                  colid: 198103,
                  isfk: true
                },
                {
                  col: 1,
                  reftable: 'T_V_IESSTORE_WITHNOPERMISSION(2)',
                  objdisplay: 'object(2)',
                  display: 'text(2)',
                  length: 20,
                  reftableid: 10866,
                  ...
                  row: 1,
                  serviceId: null,
                  inputname: 'INSTOREID:STORENAME(2)',
                  colid: 198106,
                  isfk: true
                },
                {
            ...
            {
              hrdisplay: 'expand(2)',
              parentname: '(T_V_WMSALLOCATEBILL.ID+100)(2)',
              size: 1,
              parentdesc: '日志(2)',
              childs: [
                {
        ...
        const data = Object.assign({}, data1.data, data2);// 将对象2的值赋值给对象1
        const concatArray = data.addcolums.concat(data2.addcolums);// 整合两个数组对象为一个
