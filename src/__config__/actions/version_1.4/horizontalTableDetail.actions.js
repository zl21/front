...
export default {
  ...
  performMainTableSaveAction({ commit }, { parame, resolve, reject }) { // 主表保存
    const {
      buttonInfo, tabrelation, itemObjId, tableName, objId, path, type, itemName, itemCurrentParameter, isreftabs, itemNameGroup, sataType, temporaryStoragePath, jflowPath
    } = parame;
