<template>
  ...
  <div class="TodoProcess">
    <div class="btn-agent">
      ...
      <span class="agentshow" v-if="Agent.AGENT_ENAME&&Agent.AGENT_ENAME!==''">代理人：{{Agent.AGENT_ENAME}}</span>
    </div>
    <FormItemComponent
      class="form"
                  ...
                  "span",
                  {
                    ...
                    on: {
                      click: () => {
                        window.open(
                          `http://${
                            window.jflowPlugin.jflowIp
                          }/#/FlowChart?instanceId=${params.row.instanceId}`,
                          "_blank",
