export default { 
  ...
  tips: {
    ...
    loginVerification:'Please hold down the slider and drag to the far right',
    loginVerificationdrag:'Drag the slider to verify',
    loginVerificationsucceed:'successfully',
