...
const proxyLists = ['/p/c', '/frr-center', '/eplan-center', '/ad-app', '/r3/qiaochu', '/retailcloud-crm2'];
...
module.exports = env => ({
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({ 
      name: '', 
      remotes: {
        arkui_BCL: 'arkui_BCL@https://cdn.jsdelivr.net/npm/@syman/ark-ui-bcl@0.0.6/dist/remoteEntry.js',
